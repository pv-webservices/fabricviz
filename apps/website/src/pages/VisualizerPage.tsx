...
const STYLE_AREAS = [
  ...
  { id: 'chair_seat',   label: 'Chair Seat',    category: 'sofa',      icon: Sofa },
  { id: 'chair_back',   label: 'Chair Back',    category: 'sofa',      icon: Sofa },
  { id: 'chair_all',    label: 'Chair (Full)',  category: 'sofa',      icon: Sofa },
