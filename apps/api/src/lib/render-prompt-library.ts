...
export const AREA_PROMPT_FRAGMENTS: Record<string, AreaPromptFragment> = {
  sofa_seat: {
    ...
    drapingInstruction:
      'replace the upholstery fabric covering the seat cushions with the provided textile swatch, maintaining realistic fabric folds, tuck lines, and seat compression creases',
    materialContext:
  ...
  sofa_back: {
    ...
    drapingInstruction:
      'replace the upholstery on the sofa backrest with the provided textile swatch, preserving button tufting detail if present, realistic fold shadows, and vertical alignment of fabric grain',
  ...
  sofa_all: {
    ...
    drapingInstruction:
      're-upholster the entire sofa with the provided textile swatch as a continuous fabric, wrapping naturally over arms, back, and seat with realistic tension lines and corner folding',
    materialContext:
  ...
  front_curtain: {
    ...
    drapingInstruction:
      'replace the front curtain panel fabric with the provided textile swatch, showing natural vertical pleating, light diffusion, and soft cascade folds falling from the curtain rod to the floor',
    materialContext:
  ...
  back_curtain: {
    ...
    drapingInstruction:
      'replace the back drape panel with the provided textile swatch, showing deep formal pleats (pinch pleat or goblet pleat), rich fabric weight, and floor-length formal hang',
    materialContext:
  ...
  headboard: {
    ...
    drapingInstruction:
      'replace the headboard upholstery with the provided textile swatch, wrapping fabric tightly over the headboard frame with smooth tension, piped edges if present, and realistic padding depth',
    materialContext:
  ...
  cushion: {
    ...
    drapingInstruction:
      'replace the cushion cover fabric with the provided textile swatch, showing natural plumpness, corner stitching visible, and fabric draping slightly over cushion edges',
    materialContext:
  ...
  rug: {
    ...
    drapingInstruction:
      'replace the rug with the provided textile swatch rendered as a flat woven rug, showing pile texture, border detail if applicable, and correct perspective foreshortening for floor plane',
    materialContext:
  ...
  floor: {
    ...
    drapingInstruction:
      'replace the flooring material with the provided textile or material swatch, tiling realistically across the floor plane with correct perspective, grout lines or weave repeat as appropriate',
    materialContext:
  ...
  accent_wall: {
    ...
    drapingInstruction:
      'apply the provided textile or wallcovering swatch to the accent wall surface only, maintaining wall plane geometry, corner transitions, and realistic surface texture and scale',
    materialContext:
  ...
  all_walls: {
    ...
    drapingInstruction:
      'apply the provided textile or wallcovering swatch uniformly to all visible wall surfaces, maintaining consistent scale, corner transitions, and realistic texture across the room',
    materialContext:
